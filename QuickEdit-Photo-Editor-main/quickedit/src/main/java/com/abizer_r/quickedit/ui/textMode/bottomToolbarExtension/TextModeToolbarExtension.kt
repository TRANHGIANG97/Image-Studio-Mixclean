...
import com.abizer_r.quickedit.ui.textMode.bottomToolbarExtension.textFormatOptions.sizeOptions.FontSizeOptions
...
fun TextModeToolbarExtTextFormat(
    ...
    Column(
        ...
        Row(
            ...
            FontSizeOptions(
                modifier = Modifier.weight(1f),
                onDecreaseClicked = { onEvent(UpdateTextFontSize(-2f)) },
                onIncreaseClicked = { onEvent(UpdateTextFontSize(2f)) }
            )
        }
    }
}
