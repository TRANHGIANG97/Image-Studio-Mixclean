    ...
    Dialog(
        ...
        Box(
            modifier = Modifier.background(
                color = EditorColorPalette.DarkPanel,
            ...
            Column(
                ...
                Spacer(Modifier.height(8.dp))
                Text(
                    text = stringResource(R.string.aspect_ratio_equals, getAspectRatioText(aspectX, aspectY)),
                    style = bodyTextStyle
                )
                Spacer(Modifier.height(16.dp))
                Text(
                    text = stringResource(R.string.min_allowed_aspect_ratio, MIN_RATIO),
                    style = bodyTextStyle
                )
                Spacer(Modifier.height(4.dp))
                Text(
                    text = stringResource(R.string.max_allowed_aspect_ratio, MAX_RATIO),
                    style = bodyTextStyle
                )
                Spacer(Modifier.height(16.dp))
                Button(
...
private fun getAspectRatioText(x: String, y: String): String {
    return getAspectRatio(x, y)?.toString() ?: "..."
}
