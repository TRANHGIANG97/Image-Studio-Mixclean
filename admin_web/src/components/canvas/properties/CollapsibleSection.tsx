  ...
  return (
    <div className="rounded-2xl bg-white border border-slate-200/80">
      ...
      >
        ...
        <span className="text-[10px] font-extrabold text-slate-500 uppercase tracking-wider flex-1">{title}</span>
        <ChevronDown className={`w-3.5 h-3.5 text-slate-400 transition-transform duration-200 ${isOpen ? 'rotate-0' : '-rotate-90'}`} />
      </button>
